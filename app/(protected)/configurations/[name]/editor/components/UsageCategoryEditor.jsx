...
import toast from "react-hot-toast"; // Make sure to import this!
import {
  ArrowLeft,
  Plus,
  Trash2,
...
export default function UsageCategoryEditor({
  initialData, // ✅ Changed to initialData to match the parent router
  configName,
  isViewMode,
  companyId, // ✅ Added to match the parent router
  updateConfig, // ✅ Added to match the parent router
  isSaving,
  router,
}) {
